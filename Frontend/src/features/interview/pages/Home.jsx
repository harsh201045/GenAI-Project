...
const GENERATION_STEPS = [
    { label: "Reading your resume", duration: 4000 },
    { label: "Understanding the job requirements", duration: 6000 },
    { label: "Comparing your profile to the role", duration: 7000 },
    { label: "Identifying skill gaps", duration: 6000 },
    { label: "Crafting your interview questions", duration: 6000 },
    { label: "Building your preparation roadmap", duration: 5000 },
]
...
const GenerateLoadingScreen = () => {
    ...
    const progressPercent = ((stepIndex + 1) / GENERATION_STEPS.length) * 100

    return (
        <main className='generate-loading'>
            <div className='generate-loading__card'>
                ...
                <p className='generate-loading__subtitle'>This usually takes about 30 seconds</p>

                <div className='generate-loading__progress-track'>
                    <div
                        className='generate-loading__progress-fill'
                        style={{ width: `${progressPercent}%` }}
                    />
                </div>

                <ul className='generate-loading__steps'>
...
const UserMenu = () => {
    ...
    return (
        <div className='user-menu' ref={menuRef}>
            <button className='user-menu__avatar' onClick={() => setOpen(o => !o)}>
                {initial}
            </button>
            {open && (
...
const Home = () => {
    ...
    const handleRemoveFile = () => {
        ...
        resumeInputRef.current.value = ""   // clears the actual input too
    }

    const handleGenerateReport = async () => {
        const resumeFile = selectedFile ? selectedFile : null
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <div className='file-selected'>
                                    ...
                                    <div className='file-selected__info'>
                                        ...
                                        <p className='file-selected__size'>{(selectedFile.size / 1024).toFixed(0)} KB</p>
                                    </div>
                                    <button
                                        type='button'
