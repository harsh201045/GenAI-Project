            ...
            {open && (
                <div className='q-card__body'>
                    <div className='q-card__section'>
                        <span className='q-card__tag q-card__tag--intention'>Intension</span>
                        <p>{item.intension}</p>
                    </div>
                    <div className='q-card__section'>
...
const Interview = () => {
    ...
    const { report, loading, getReportById, pdfLoading, getResumePdf } = useInterview()
            ...
            <div className='interview-layout'>
                ...
                <div className='nav-footer'>
                    ...
                    <div className='nav-user'>
                            ...
                            <span className='nav-user__name'>{user?.username || 'Account'}</span>
                            <button className='nav-user__logout' onClick={onLogout} aria-label="Log out">
